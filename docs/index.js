...
var render = ({
  ...
  <p>
    ...
    20% will be sold in the first window &mdash; lasting about five
    days.  The remaining 70% will be divided equally into 365 windows
    &mdash; each lasting 23 hours.  Contributions can be made to any
    future window.  Once a window closes, the EOS tokens allocated to
    that window are available to be claimed.
